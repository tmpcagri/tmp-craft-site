...
export default async function ModPaketleriPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-white dark:bg-black">
      {/* Tam sayfa atmosferik arka plan -- diğer sayfalardaki (content-page.tsx,
          projeler/page.tsx) desenin aynısı: görsel en arkada, üstünde okunabilirlik
          için hafif bir overlay, tüm gerçek içerik bunun üstünde (relative z-10)
          akıyor. Patron ayarlamadıysa (varsayılan boş) hiçbir şey render edilmiyor. */}
      {backgroundImageUrl && (
        <>
