...
export default function OnerilenYayincilarSidebar({
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col gap-px overflow-hidden rounded-3xl border border-black/10 bg-white/40 shadow-sm backdrop-blur-xl dark:border-white/10 dark:bg-black/40 lg:sticky lg:top-36 lg:max-h-[calc(100vh-10rem)] lg:w-80 lg:overflow-y-auto">
      {premium.length > 0 && (
        <div>
